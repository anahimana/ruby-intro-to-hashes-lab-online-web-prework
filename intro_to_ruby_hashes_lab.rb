...
puts monopoly_with_fourth_tier.values[0][:names].values[0].has_key?("mortgage_value")).to be true
puts (monopoly_with_fourth_tier.values[0][:names].values[0].values[0]).to eq("$100")
